...
public class CountryTest {
    ...
    public void createCountry()
    {
        ...
        country.setName(countryName);  // genetareCountryName
    ...
    {
        // "message" : "The Country with name \"xdarrflo\" already exists.",
